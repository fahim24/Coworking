	...
	return (
		<section className=" relative">
			...
			<div className="container mx-auto px-10 py-24 grid grid-cols-2 gap-20">
				<div className="flex flex-col gap-5 w-3/4 text-CDark">
					<h3 className="text-4xl font-bold">Work around very talented people.</h3>
					<p className="text-lg opacity-70">
						With lots of unique blocks, you can easily build a page easily without any coding.
					</p>
				</div>
				<div className="row-span-2 ">
					<img src={Loc5} alt="" className="object-cover rounded-lg h-[600px] w-full shadow1" />
				</div>
				<div className="">
					<img src={Loc4} alt="" className="object-cover rounded-lg h-[600px] w-full shadow1" />
				</div>
			</div>
		</section>
	);
